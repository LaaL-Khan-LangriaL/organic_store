...
$dat=$object->getRow('order','id',$_GET['id']);
          ...
          <div class="col-12">
              ...
              <div class="row invoice-info">
                ...
                <div class="col-sm-4 invoice-col">
                  <address><br>
                    ...
                    <?=$data['address_2']?> <?=$dat['zip']?><br>
                    <?=$data['address']?> <?=$dat['country']?><br>
                    <?=$data['phone']?><br>
                    <?=$data['email']?>
                  </address>
                </div>
                ...
                <div class="col-sm-4 invoice-col"><br>
                  <br><b>Invoice:</b>#321-8<?=$dat['id']?><br>
                  <b>Order ID:</b>#123-7<?=$dat['id']?><br>
                  <b>Payment Due:</b> <?=$data['date']?><br>
                  <b>Account:</b> 231-9<?=$dat['id']?>
                </div>
                <!-- /.col -->
              </div><br>
              <!-- /.row -->
            ...
            ?>
              ...
              <div class="row">
                ...
                <!-- /.col -->
                <div class="col-6">
                  <p class="lead" style="color: #2EB26E;"><b>Amount Due &nbsp;&nbsp;<?=$data['date']?></b></p>
              ...
              <div class="row no-print">
                <div class="col-sm-4 offset-8">
                  ...
                  <a name="submit" class="btn btn-success float-right" href="http://localhost/organicstore/views/thanku.php?id=<?=$_GET['id']?>"> <i class="far fa-credit-card"></i>SubmitPayment</a>
