...
if(isset($_POST['name'])){
  ...
  $object->Update_Salads_Data($_POST);
}

if (isset($_GET['id'])) {

  $data=$object->getRow('salads','id',$_GET['id']);
 ...
 <form method="POST">
  ...
  <i class="fab fa-pagelines animate flash"></i> Organic Store</span></div>
    ...
    <button type="submit" name="submit" class="btn btn-success" style="background-color:#2EB26E;">
              Update Salad &nbsp; <i class="fa fa-save" aria-hidden="true"></i></button>
