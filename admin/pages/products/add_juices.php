...
$data['image']=$object->Juice_Images();
...
unset($data['submit']);
 ...
 $object->Insert_Data('juices',['name','keywords','price','shipping','description','image','slug'],$data);
...
<div class="container">
  ...
  <i class="fab fa-pagelines animate flash"></i> Organic Store</span></div>
    ...
    <button type="submit" name="submit" class="btn btn-success" style="background-color:#2EB26E;">
              Save Juice &nbsp; <i class="fa fa-save" aria-hidden="true"></i></button>
