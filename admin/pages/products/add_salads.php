...
$data['image']=$object->Salad_Images();
...
unset($data['submit']);
 ...
 $object->Insert_Data('salads',['name','keywords','price','shipping','description','image','slug'],$data);
...
<div class="container">
  ...
  <div class="row mt-5">
    <div class="col-md-12">
      <a href="http://localhost/organicstore/admin/pages/products/salads.php" 
  ...
  <i class="fab fa-pagelines animate flash"></i> Organic Store</span></div>
        <div class="card-body">
          ...
          <div class="row mt-4">
            <div class="col-md-12">
              <label><b>Juice Description</b></label>
    ...
    <button type="submit" name="submit" class="btn btn-success" style="background-color:#2EB26E;">
              Save Salad &nbsp; <i class="fa fa-save" aria-hidden="true"></i></button>
